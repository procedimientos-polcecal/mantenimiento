      ...
      <div className="no-print fixed top-4 right-4 z-10 flex gap-2">
        ...
        <button
          onClick={() => {
            ...
            document.title = `Plan_${plan.fecha}`;
            window.print();
            document.title = prev;
          }}
          className="flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-lg hover:bg-blue-700 transition-colors">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
